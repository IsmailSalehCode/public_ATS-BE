// a lot of manual work here, but it is okay.
const users = [
  {
    // specifying an id, so that when it gets autogenerated, im not kicked out due to an invalid JWT
...
const attendanceEntries = [
  // 6d738fa1 in 2023 in order to test the startDt and endDt
  {
    kioskId: "a54dd590-e4ab-40da-850c-987f6b8258b6",
    NFCtagID: "6d738fa1",
    isWorking: 1,
  ...
  // 1 day, 1 hour, 15 minutes, 20 seconds 6d738fa1 - 30min+1day 45min 20s
  {
    kioskId: "a54dd590-e4ab-40da-850c-987f6b8258b6",
    NFCtagID: "6d738fa1",
    isWorking: 1,
  ...
  },
  {
    ...
    NFCtagID: "6d738fa1",
    isWorking: 0,
    createdAt: "2024-07-19T09:45:20Z",
  },

  // Incorrect entries 5d4429a2
  {
    kioskId: "a54dd590-e4ab-40da-850c-987f6b8258b6",
    NFCtagID: "5d4429a2",
    isWorking: 1,
